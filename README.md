...
- اضافه شدن Back stack داخلی و جلوگیری از خروج ناخواسته از صفحات داخلی
- تثبیت منوی همبرگری راست‌چین و بستن صحیح Drawer با Back
- ساده‌سازی صفحه «درباره نرم افزار» به توضیح برنامه و نسخه
- اصلاح لینک‌های Share و Update Checker به ریپوی `App-QrCodeYar`
- جلوگیری از باقی ماندن رکورد ناقص در MediaStore هنگام خطای ذخیره خروجی
- افزایش کامنت‌های توضیحی و اضافه شدن راهنمای فارسی سورس
